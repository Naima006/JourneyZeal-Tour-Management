...
const TourDetails = () => {
    ...
    const tour = tourData.find((tour) => tour.id === id); //Static data, call API to load data from db
    ...
    const submitHandler = (e) => {
        ...
        //alert(`${reviewText}, ${tourRating}`);    Later, instead of this, call api.
    };
                                                ...
                                                <div className="w-100">
                                                    <div className="d-flex align-items-center justify-content-between">
                                                        <div>
                                                            <h5>user</h5>
                                                            <p>
                                                                {new Date("10-27-2024").toLocaleDateString(
                                                                    "en-US",
                                                                    options
                                                                )}
                                                            </p>
                                                    ...
                                                    <h6>
                                                        Had an unforgettable experience. Highly recommended!
                                                    </h6>
                                                </div>
                                            </div>
                                        ))}
